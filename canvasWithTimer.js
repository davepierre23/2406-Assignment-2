...
function handleMouseMove(e){
	...
	wordBeingMoved.isMoving = userName;
...
function handleSubmitButton() {
	...
	if(userText && userText != ''){
	   //user text was not empty
		 console.log("this is ur text" + userText);
...
function handleLoginButton() {
  ...
  if(loginTestField &&loginName !=""){
		userName = document.getElementById('loginTextField').value;
...
$(document).ready(function(){
	...
	$(document).keyup(handleKeyUp);
	 ...
	 pollingTimer = setInterval(pollingTimerHandler, 100);
